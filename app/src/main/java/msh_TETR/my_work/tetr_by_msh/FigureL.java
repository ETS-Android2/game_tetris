...
public final class FigureL extends TetrFigure {

    //X - angle of figureI at axis OX
    //Y - angle of figureI at axis OY


    public FigureL(FigureDirection direction, int color){
    ...
    public void turnFigure() {
        ...
        {
            case Top:
                if(X == 0 || FieldActivity.gameField.mapOfField.get(Y).get(X - 1) || FieldActivity.gameField.mapOfField.get(Y - 1).get(X - 1))
                {
                    if(X + 2 < FieldActivity.gameField.nColumns && !FieldActivity.gameField.mapOfField.get(Y - 1).get(X + 1) && !FieldActivity.gameField.mapOfField.get(Y - 1).get(X + 2))
                        forTurn(FigureDirection.Right, 0, -1);
                }
                else
                    if(FieldActivity.gameField.mapOfField.get(Y - 1).get(X + 1))
                    {
                        if(X - 2 >= 0 && !FieldActivity.gameField.mapOfField.get(Y - 1).get(X - 1) && !FieldActivity.gameField.mapOfField.get(Y - 1).get(X - 2) && !FieldActivity.gameField.mapOfField.get(Y).get(X - 2))
                            forTurn(FigureDirection.Right, -2, -1);
                    }
                    else
            ...
            case Right:
                if(Y == 0 || FieldActivity.gameField.mapOfField.get(Y - 1).get(X) || FieldActivity.gameField.mapOfField.get(Y - 1).get(X + 1))
                {
                    if(Y + 2 < FieldActivity.gameField.nRows && !FieldActivity.gameField.mapOfField.get(Y + 1).get(X + 1) && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X + 1))
                        forTurn(FigureDirection.Bottom, 1, 0);
                }
                else
                    if(FieldActivity.gameField.mapOfField.get(Y + 1).get(X + 1))
                    {
                        if(Y - 2 >= 0 && X - 1 >= 0 && !FieldActivity.gameField.mapOfField.get(Y - 1).get(X + 1) && !FieldActivity.gameField.mapOfField.get(Y - 2).get(X + 1) && !FieldActivity.gameField.mapOfField.get(Y - 2).get(X))
            ...
            case Bottom:
                if(X == FieldActivity.gameField.nColumns - 1 || FieldActivity.gameField.mapOfField.get(Y + 1).get(X + 1) || FieldActivity.gameField.mapOfField.get(Y + 2).get(X + 1))
                {
                    if(X - 2 >= 0 && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X - 1) && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X - 2))
                        forTurn(FigureDirection.Left, 0, 2);
                }
                else
                if(FieldActivity.gameField.mapOfField.get(Y + 2).get(X - 1))
                {
                    if(X + 2 < FieldActivity.gameField.nColumns && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X + 1) && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X + 2) && !FieldActivity.gameField.mapOfField.get(Y + 1).get(X + 2))
                        forTurn(FigureDirection.Left, 2, 2);
                }
                else
                    forTurn(FigureDirection.Left, 1, 2);
                break;

            case Left:
                if(FieldActivity.gameField.mapOfField.get(Y - 1).get(X - 1))
                {
                    if(Y + 2 < FieldActivity.gameField.nRows && !FieldActivity.gameField.mapOfField.get(Y + 1).get(X - 1) && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X - 1) && !FieldActivity.gameField.mapOfField.get(Y + 2).get(X))
                        forTurn(FigureDirection.Top, -1, 2);
                }
                else
                if(Y == 1 || FieldActivity.gameField.mapOfField.get(Y - 2).get(X - 1))
                {
                    if(Y + 1 < FieldActivity.gameField.nRows && !FieldActivity.gameField.mapOfField.get(Y - 1).get(X - 1) && !FieldActivity.gameField.mapOfField.get(Y + 1).get(X - 1) && !FieldActivity.gameField.mapOfField.get(Y + 1).get(X))
